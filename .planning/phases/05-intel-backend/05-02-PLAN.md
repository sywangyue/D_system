...
- 所有 SQL 使用参数化查询，不拼接字符串
  ...
  <verify>
    <automated>cd "/Volumes/databoard/AI Project/D_dashboard" && python3 tools/intel/db_query.py brand-research "EXPO-0001" | head -5 && python3 tools/intel/db_query.py industry-research "机械和设备" | head -3</automated>
  </verify>
