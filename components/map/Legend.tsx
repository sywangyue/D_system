  ...
  return (
    <div className="absolute bottom-4 right-4 z-[1000] bg-white rounded-lg shadow-md border border-border px-3 py-2 text-xs">
      ...
      <div className="flex items-center gap-2 mb-1">
        <span className="inline-block w-3 h-3 rounded-full" style={{ backgroundColor: "#fe5c00" }} />
        <span className="text-gray-600">国内展会</span>
      </div>
      <div className="flex items-center gap-2 mb-1.5">
        <span className="inline-block w-3 h-3 rounded-full" style={{ backgroundColor: "#ff8c00" }} />
